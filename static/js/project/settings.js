...
// Keybinds
let Binds = {
    leaveAutoShape: 'Escape' // Shapes automatically follow your mouse until you press this button
}

function keyDown(key) { // Simpler than if(keys[Binds.blahBlah])
    return (keys[Binds[key]] || keys[key]) ? true : false
}